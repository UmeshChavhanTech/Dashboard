...
const jwtDecodeFunc = (jwtDecodeModule as any).default || jwtDecodeModule;
...
const Chat = () => {
    ...
    if (token && typeof token === 'string') {
        try {
            ...
            userEmail = typeof decodedToken.email === 'string' ? decodedToken.email : null;
        } catch (error) {
    ...
    useEffect(() => {
        ...
        if (!userEmail || userEmail.toLowerCase() !== 'umeshchavhan538@gmail.com') {
